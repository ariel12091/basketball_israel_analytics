-- EUROLEAGUE SHADOW SCHEMA -- migration 046: combined filtered player dashboard reader.
-- Additive only. The function returns four_factors_compute's 43 columns plus
-- the four fields for which the app currently calls onoff_compute separately.
