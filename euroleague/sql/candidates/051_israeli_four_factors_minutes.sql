-- Rollback-only narrow Israeli standard-clutch Four Factors + Minutes reader.
-- Measurement input only; no transaction or grant statements belong here.

CREATE OR REPLACE FUNCTION basketball_test.get_team_four_factors_minutes_probe_20260901(
    p_game_year INT,
