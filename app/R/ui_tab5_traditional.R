    ...
    sidebarLayout(
      ...
      mainPanel(
        ...
        tab_explainer(
          ...
          bullets = c(
            "Each row shows Team, Player, GP, Poss on Floor, MIN, PTS, REB, AST, STL, BLK, TOV, FGM, FGA, FG%, 3PM, 3PA, 3P%, FTM, FTA, FT%, eFG%, and TS%. Non-total modes also show Total Poss from the totals-mode possession count.",
