...
DROP MATERIALIZED VIEW IF EXISTS basketball_test.player_advanced_stats_mv;
DROP TABLE IF EXISTS basketball_test.player_advanced_stats_mv;

CREATE TABLE basketball_test.player_advanced_stats_mv AS
WITH sched AS (
         ...
         SELECT fr.player_id,
           ...
           FROM full_rosters fr
           JOIN schedule s ON s.game_id = fr.game_id
